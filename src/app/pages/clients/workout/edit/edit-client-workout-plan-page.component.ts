...
@Component({
  templateUrl: 'edit-client-workout-plan-page.component.html'
})
export class EditClientWorkoutPlanPageComponent extends BaseClientsPageComponent implements OnInit {
